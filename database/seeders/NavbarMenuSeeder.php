            ...
            [
                ...
                "childrens" => [
                    [
                        ...
                        "external_link" => "/administration/প্রতিষ্ঠাতা",
                    ],
                    [
                        "title" =>     "সভাপতি",
                        "serial" => "",
                        "is_visible" => true,
                        "goto_external_link" => 1,
                        "external_link" => "/administration/সভাপতি",
                    ],
                    [
                        "title" =>       "অধ্যক্ষ",
                        "serial" => "",
                        "is_visible" => true,
                        "goto_external_link" => 1,
                        "external_link" => "/administration/অধ্যক্ষ",
                    ],
                    [
                        "title" =>      "উপাধ্যক্ষ",
                        "serial" => "",
                        "is_visible" => true,
                        "goto_external_link" => 1,
                        "external_link" => "/administration/উপাধ্যক্ষ",
                    ],
                    [
                        "title" =>   "শিক্ষক",
                        "serial" => "",
                        "is_visible" => true,
                        "goto_external_link" => 1,
                        "external_link" => "/administration/শিক্ষক",
                    ],
                    [
                        "title" =>   "অফিস",
                        "serial" => "",
                        "is_visible" => true,
                        "goto_external_link" => 1,
                        "external_link" => "/administration/অফিস",
                    ],
                    [
                        "title" => "কর্মচারী",
                        "serial" => "",
                        "is_visible" => true,
                        "goto_external_link" => 1,
                        "external_link" => "/administration/কর্মচারী",
                    ],
