...
class NewsSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        News::create([
            ...
            "image" => "frontend/assets/images/news_img/img1.jpg"
        ]);
        News::create([
            "news_category_id" => 2,
            "title" => "extracurricular programs",
            "description" => "This category covers news about students' academic accomplishments, including honors, awards, scholarships, and noteworthy academic achievements. It showcases the excellence of students in various subjects and fields.",
            "image" => "frontend/assets/images/news_img/img2.jpg"
        ]);
        News::create([
            "news_category_id" => 3,
            ...
            "image" => "frontend/assets/images/news_img/img3.jpg"
        ]);
        News::create([
            "news_category_id" => 4,
            ...
            "image" => "frontend/assets/images/news_img/img4.jpg"
        ]);
        News::create([
            "news_category_id" => 5,
            ...
            "image" => "frontend/assets/images/news_img/img5.jpg"
        ]);
    }
}
