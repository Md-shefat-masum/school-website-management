...
class NavbarMenuController extends Controller
{
    public function all()
    {
        ...
        $query = NavbarMenu::where('status', $status)->orderBy($orderBy, $orderByType);
    ...
    public function store()
    {
        ...
        $data->icon_image = request()->icon_image;
    ...
    public function update()
    {
        ...
        $data = NavbarMenu::find(request()->id);
    ...
    public function bulk_import()
    {
        ...
        foreach (request()->data as $item) {
            ...
            $item = (object) $item;
            $check = NavbarMenu::where('id', $item->id)->first();
            if (!$check) {
                try {
                    NavbarMenu::create((array) $item);
                } catch (\Throwable $th) {
                    return response()->json([
                        'err_message' => 'validation error',
