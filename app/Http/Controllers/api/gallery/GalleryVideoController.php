...
class GalleryVideoController extends Controller
{
    ...
    public function store()
    {
        $validator = Validator::make(request()->all(), [
            'gallery_video_categories_id' => ['required'],
            'title' => ['required'],
            'link' => ['required'],
        ...
        $data = new GalleryVideo();
        $data->gallery_video_categories_id = request()->gallery_video_categories_id;
    ...
    public function update()
    {
        ...
        $data = GalleryVideo::find(request()->id);
    ...
    public function bulk_import()
    {
        ...
        foreach (request()->data as $item) {
            ...
            $item = (object) $item;
            $check = GalleryVideo::where('id', $item->id)->first();
            if (!$check) {
                try {
                    GalleryVideo::create((array) $item);
                } catch (\Throwable $th) {
                    return response()->json([
                        'err_message' => 'validation error',
