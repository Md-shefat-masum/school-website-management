    ...
    actions: {
        all: async function (url) {
            ...
            if (url) {
                ...
                response = await axios.get('/news/all')
            }
        ...
        store: async function (form) {
            let response = await axios.post('/news/store', form)
            window.s_alert("Data created")
            console.log("res", response.data);
        },
        update: async function (form) {
            let response = await axios.post('/news/update', form)
        ...
        delete: async function (id) {
            ...
            if (data) {
                let response = await axios.post('/news/destroy?id=' + id)
