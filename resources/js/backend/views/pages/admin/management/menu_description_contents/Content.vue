                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4">
                            <div class="form-group">
                                ...
                                <input type="text" v-model="data.details.source_title" name="source_title" class="form-control mt-1 mb-2">
                            </div>
                            <div class="form-group mt-3">
                                <label for="">Source URL</label>
                                <input type="text" v-model="data.details.source_url" name="source_url" class="form-control mt-1 mb-2">
                                <a v-if="data.details.source_url" :href="data.details.source_url" target="_blank">source file url</a>
                            </div>
                            <div class="form-group mt-3">
                                <label for="">Source File</label>
                                <input type="file" name="source_file" class="form-control mt-1 mb-2">
                                <a v-if="data.details.source_file" :href="'/'+data.details.source_file" target="_blank">source file link</a>
                            </div>
                        </div>
                    </div>
                </div>
